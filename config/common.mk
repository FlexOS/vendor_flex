...
ifeq ($(FLEX_BUILDTYPE), RELEASE)
    ifndef TARGET_VENDOR_RELEASE_BUILD_ID
        FLEX_VERSION := flexos_$(PLATFORM_VERSION)_$(PRODUCT_VERSION_MAINTENANCE)$(PRODUCT_VERSION_DEVICE_SPECIFIC)-$(FLEX_BUILD)
    else
        ifeq ($(TARGET_BUILD_VARIANT),user)
            FLEX_VERSION := flexos_$(PLATFORM_VERSION)_$(TARGET_VENDOR_RELEASE_BUILD_ID)-$(FLEX_BUILD)
        else
            FLEX_VERSION := flexos_$(PLATFORM_VERSION)_$(PRODUCT_VERSION_MAINTENANCE)$(PRODUCT_VERSION_DEVICE_SPECIFIC)-$(FLEX_BUILD)
        endif
    endif
